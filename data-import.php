<?php
    ...
    $url = 'https://api.openweathermap.org/data/2.5/weather?q='.$_GET['city'] . '&appid=b748c6a40b1cac474d995b5f38d02570&units=metric';
    ...
    $sql_insert = "INSERT INTO weather (weather_description, weather_temperature, weather_wind, weather_time, city)
