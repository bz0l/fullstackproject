...
crossorigin="anonymous">
	...
	<body>
		...
		<div class="mb-3">
			...
			<input type="text" class="form-control" id="game_name" name="GameName">
		</div>
		<div class="mb-3">
			<label for="GameDescription" class="form-label">Description</label>
			<textarea class="form-control" id="game_desc" name="GameDescription" rows="5"></textarea>
		</div>
		<div class="mb-3">
		...
		<div class="mb-3">
			...
			<input type="number" class="form-control" id="rating" name="GameRating">
		</div>
